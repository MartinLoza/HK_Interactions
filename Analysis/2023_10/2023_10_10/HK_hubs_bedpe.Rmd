...
I would like to visualize housekeeping hubs in the micro c data
...
hub_ppi <- interactions %>% filter(gene_from %in% hub_genes)
```
...
write.table(x = tmp_bedpe,
            paste0(file = "~/Documents/Projects/HK_Interactions/Analysis/2023_10/2023_10_10/tmp_results/hub_cp_top_",n_top,".bedpe"),
